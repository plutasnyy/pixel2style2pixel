...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--batch_size', default=4, type=int, help='Batch size for psp_training')
		...
		self.parser.add_argument('--max_steps', default=500000, type=int, help='Maximum number of psp_training steps')
		self.parser.add_argument('--image_interval', default=100, type=int, help='Interval for logging train images during psp_training')
